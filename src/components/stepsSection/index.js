  ...
  return (
    <div className="w-full  transition duration-150 ease-in-out flex flex-col justify-start items-start  bg-transparent">
      ...
      <div className="relative mt-[50px] md:mt-[100px] max-w-7xl">
        <h1 className="gra-Leg-Btn  uppercase pb-[10px] lg:pb-[21px] py-4 absolute -top-[40px] md:-top-[70px] text-[8px] sm:text-sm md:text-[26px] lg:text-[36px] ">
          Legendary
        </h1>
        <img src={StepsLine} className="w-full relative" alt="" />
        <span className="uppercase left-[0px] -top-2 sm:top-2 sm:left-[0px] md:top-[21px] md:left-[0px] lg:top-[21px] gra-Leg-Btn lg:left-[0px] xl:left-[0px] pb-[10px] py-4 absolute lg:pb-[21px] text-[8px] sm:text-sm md:text-[26px] lg:text-[36px]">
          1bnb
        </span>

        <div className="uppercase left-[21%]  -top-[10%]  p-4 lg:top-[13%] sm:top-[0%]  md:top-[8%] xl:top-[11%] absolute  text-[8px] sm:text-sm ron-text-gra md:text-[26px] flex flex-col gap-4 lg:gap-16 sm:gap-10 lg:text-[36px]">
          <span>hero</span>
          <span>0.5bnb</span>
        </div>
        ...
        <div className="uppercase -right-[2%] lg:-right-[3%] p-4 top-[70%] lg:top-[84%] sm:top-[70%]  md:top-[80%] xl:top-[82%] absolute  text-[8px] sm:text-sm white-text-gra md:text-[26px] flex flex-col gap-4 sm:gap-10 lg:gap-16 lg:text-[36px]">
          <span>Ancestral</span>
          <span>10 gold</span>
        </div>
      </div>
