...
const TabContent = ({ title, paragraph, icon, id, btn, img, condition }) => {
  return (
    <>
      <section
        id={id}
        className="grid lg:flex bg-transparent  z-50 gap-2 md:gap-24  grid-cols-1 tab-content max-h-[100vh] place-items-center place-content-center  relative lg:pt-44 max-w-7xl mt-28   md:mt-20 md:mx-0   lg:mt-1 "
      >
