...
const StepsSection = () => {
  return (
    <div className="w-full  transition duration-150 ease-in-out flex flex-col justify-start items-start  bg-transparent">
      ...
      <div className="relative mt-[100px] max-w-7xl">
        <h1 className="gra-Leg-Btn  uppercase pb-[10px] lg:pb-[21px] py-4 absolute -top-[70px] text-xs md:text-[26px] lg:text-[36px] ">
          Legendary
        </h1>
        ...
        <div className="uppercase right-[0%] lg:-right-[3%] p-4 top-[70%] lg:top-[84%] sm:top-[70%]  md:top-[80%] xl:top-[82%] absolute  text-xs white-text-gra md:text-[26px] flex flex-col gap-4 sm:gap-10 lg:gap-16 lg:text-[36px]">
          <span>Ancestral</span>
          <span>10 gold</span>
        </div>
      </div>
