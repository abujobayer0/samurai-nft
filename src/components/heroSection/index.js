  ...
  return (
    <>
      <section className="mt-[50px] mx-auto max-w-7xl px-5 sm:px-10">
        ...
        <p className="uppercase text-[14px] sm:text-[16px] text-[#BCBCBC]  mt-[25px] text-center leading-[30px]">
        ...
        <div className="w-full mt-[30px] flex flex-col mx-auto justify-center items-center">
          ...
          <div className="flex mx-auto justify-center items-center w-full gap-2 mt-[32px]">
            <button className="flex  w-[180px] md:w-[200px] h-[52px] items-center border-2 px-4 md:pl-[17px] rounded-xl gap-[19px] py-[9px]">
              <svg
                width="24"
                height="24"
                viewBox="0 0 29 34"
              ...
              <p className="font-clash flex flex-col justify-start items-start">
                <span className="text-[8px] w-full md:text-xs lg:text-sm  flex flex-nowrap ">
                  Download on the
                </span>
