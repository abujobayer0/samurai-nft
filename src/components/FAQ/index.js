    ...
    <div className={"max-w-7xl px-5 lg:px-10 mx-auto mb-32"}>
      ...
      <Accordion transition transitionTimeout={200}>
        ...
        <AccordionItem no={"002"} header="Is 0xSamurai secure?">
          Yes, 0xSamurai is built on the blockchain and utilizes smart contracts
          to ensure that transactions are secure and transparent. The platform
          has also undergone multiple security audits to ensure the safety of
          user funds and data.
        </AccordionItem>

        <AccordionItem no={"003"} header="What is RYO?">
          There are several ways to earn rewards in 0xSamurai, including winning
          battles, completing quests, staking RYO tokens, summoning Samurais.
          Rewards can include rare NFTs, gold, and other valuable items.
        </AccordionItem>
        ...
        <AccordionItem no={"005"} header="How can I earn rewards in 0xSamurai?">
          There are several ways to earn rewards in 0xSamurai, including winning
          battles, completing quests, staking RYO tokens, summoning Samurais.
          Rewards can include rare NFTs, gold, and other valuable items.
        </AccordionItem>
