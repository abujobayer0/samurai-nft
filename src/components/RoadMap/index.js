  ...
  return (
    <div className="max-w-7xl mx-auto relative">
      ...
      <div className="w-full relative">
        ...
        <div className="absolute text-[9px] -top-8 right-[30%] md:text-[16px]  text-[#BDBDBD]  lg:text-[24px] lg:-top-10 md:left-5 md:top-44 lg:left-[25%]">
          {phrase1.map((item) => (
            <li>{item}</li>
          ))}
        </div>
        ...
        <div className="absolute w-fit top-[45%] right-0  text-[9px]  md:text-[16px] lg:text-[24px] text-[#BDBDBD] md:top-[74%] md:left-[30%] lg:top-[75%]  lg:left-[37%]">
          {phrase3.map((item) => (
